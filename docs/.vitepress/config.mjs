    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          {
            text: "LLM 应用基础概念笔记",
            link: "/notes/llm-application-basics",
          },
          { text: "WSL 常用命令速查", link: "/notes/wsl-common-commands" },
        ],
      },
      {
        text: "Playbooks",
        items: [
          {
            text: "AI Coding Rules（草案）",
            link: "/playbooks/ai-coding-rules",
          },
          {
            text: "AI Coding Review Checklist（草案）",
            link: "/playbooks/ai-coding-review-checklist",
          },
          {
            text: "Web Content Summarizer：反推任务文档（草案）",
            link: "/playbooks/web-content-summarizer-task-reverse-spec",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        items: [
          ...
          {
            text: "网页内容总结工具",
            link: "/projects/web-content-summarizer",
          },
          {
            text: "第一个小项目方向建议",
            link: "/experiments/first-project-direction",
          },
        ],
      },
    ],
